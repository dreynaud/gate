...
public class ClouddriverServiceSelector {
  ...
  private boolean shouldSelect() {
    return true;
    //    return dynamicConfigService.isEnabled(DynamicRoutingConfigProperties.ENABLED_PROPERTY,
    // false)
    //      &&
    // dynamicConfigService.isEnabled(DynamicRoutingConfigProperties.ClouddriverConfigProperties.ENABLED_PROPERTY, false);
  }
}
